...
# Standard libraries written in Python reside in the Python installation directory as .py files. You can find their 
# directory path with sys.prefix.
#
...
#
# Mac and Linux:
# pip<version> install pandas or use python3 -m pip install pandas if that doesn't work.