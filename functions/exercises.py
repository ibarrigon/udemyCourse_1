# 1. Define a function that calculates the area of a square.
# For example, if I was to call your function with foo(7) the output would 
# be 49. If I called it with foo(3)  it would return 9, and so on. Note that you 
# don't have to name your function foo. Give it any name you want.
def square_area(side):
    return side * side

print(square_area(7), square_area(3))

# 2. Define a function that converts fluid ounces to milliliters 
# knowing that 1 fluid ounce is equal to 29.57353 milliliters. For
# example, I was to call your function with foo(1) I would get an output 
# of 29.57353. If I called it with  foo(5) I would get 147.86765, and so on.
...
# 
# If I called your function with foo(10) it would return Warm. If I called
# it with foo(7) or foo(5) it would return Cold in both cases, and so on.
...
# 
# In other words, if I called your function with foo("mypass") it would return
# False. If I called it with foo("mylongpassword") it would return True, and so on.
